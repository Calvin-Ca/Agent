...
def extract_from_image(file_path: str | Path, use_vlm: bool = True) -> dict:
    """Extract text and description from an image.

    Returns:
        {
            "ocr_text": "extracted text via OCR...",
            "vlm_description": "scene description from VLM...",
            "width": int,
            "height": int,
        }
    """
    ...
    result = {"ocr_text": "", "vlm_description": "", "width": width, "height": height}
