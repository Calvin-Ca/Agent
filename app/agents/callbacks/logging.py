...
def _sync_log_node(func: Callable[[AgentState], AgentState]) -> Callable[[AgentState], AgentState]:
...
def _async_log_node(func: Callable[[AgentState], AgentState]) -> Callable[[AgentState], AgentState]:
    @functools.wraps(func)
