"""Model registry — manage models and switch between them at runtime.
...
def auto_discover_models() -> None:
    """Register models based on config. Call at app startup."""
    ...
    # Set active based on configured backend
    if settings.backend == "vllm":
